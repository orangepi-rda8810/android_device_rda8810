...
#define _TGT_AP_SDMMC3_MCLK_INV		(1)
#define _TGT_AP_SDMMC3_MCLK_ADJ		(3)
...
#  define _DEF_I2C_ADDR_TS_EKTF227      (0x15)
...
#define _TGT_AP_GSENSOR_POSITION 4
...
#  define _DEF_I2C_ADDR_LSENSOR_TAOS2771x (0x39)
/* NO need to define ADDR, this is determined by customer driver */
...
#define _TGT_AP_BL_EXT_PWT

#define _TGT_AP_BOARD_HAS_ATV

#define _TGT_AP_TARGET_OVPHONE_X3V3
