#value maybe:none,base,lite,full
...
PRODUCT_PROPERTY_OVERRIDES += \
    ro.odex.on.sdcard=0
#image can be storage to flash without external memory
PRODUCT_PROPERTY_OVERRIDES += \
    image_storage_internal=0

PRODUCT_PROPERTY_OVERRIDES += \
    ro.internal.storage.fon=1

PRODUCT_PROPERTY_OVERRIDES += \
    ro.phone.storage.default=1

PRODUCT_PROPERTY_OVERRIDES += \
    ro.sf.lcd_density=240

PRODUCT_COPY_FILES += \
    device/rda/common/res/init.storage.fonftl.rc:root/init.storage.rc \
...
PRODUCT_COPY_FILES += \
    ...
    $(foreach apk,$(PrebuildInternal_PACKAGES),$(call find-copy-subdir-files,*,vendor/3rdparty/misc/preinstallapk/$(apk)_libs,vendor/lib)) \
