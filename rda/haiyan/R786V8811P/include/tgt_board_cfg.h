    ...
    {                                                                   \
        ...
        {                                                               \
            ...
            { /* PMD_POWER_LCD          : (main) LCD LDO enable */      \
                .ldo            = { .opal = PMD_LDO_CAM|PMD_LDO_LCD},   \
                .polarity       = TRUE,                                 \
                .shared         = FALSE,                                \
                .powerOnState   = FALSE,                                \
            },                                                          \
        ...
        .vBuck1LowPower              = 6,                               \
        .vBuck3LowPower              = 13,                              \
        .vBuck4Usage                 = PMD_VBUCK4_USAGE_DDR,            \
        .vBuck4LowPower              = 13,                              \
        ...
        .batteryLevelFullMV          = 4190,                            \
        .batteryChargeTimeout        = 4 HOURS,                         \
        .batteryOffsetHighActivityMV = 75,                              \
        .batteryOffsetPowerDownChargeMV = -120,                         \
...
#define TGT_PMD_BATT_CAP_CURVE_ARRAY                                    \
    {  0,  0,  0,  1,  1,  1,  2,  2,  3,  4,                           \
       6,  9, 13, 17, 21, 28, 38, 45, 50, 54,                           \
      58, 62, 65, 68, 71, 74, 77, 79, 81, 83,                           \
      85, 87, 89, 91, 93, 95, 96, 98, 99, 100, 100 }
