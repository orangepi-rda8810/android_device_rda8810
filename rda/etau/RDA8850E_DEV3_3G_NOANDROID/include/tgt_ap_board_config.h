...
************************************************
**************************************************************************/
#define _TGT_AP_GFX_MEM_BASE	(_TGT_AP_OS_MEM_SIZE) /*218*/
#define _TGT_AP_CAM_MEM_BASE	(_TGT_AP_GFX_MEM_BASE + _TGT_AP_GFX_MEM_SIZE)/*218*/
#define _TGT_AP_VPU_MEM_BASE	(_TGT_AP_CAM_MEM_BASE + _TGT_AP_CAM_MEM_SIZE)/*222*/
#define _TGT_MODEM_MEM_BASE	(_TGT_AP_VPU_MEM_BASE + _TGT_AP_VPU_MEM_SIZE)/*240*/
#define _TGT_SMD_MEM_BASE	(_TGT_MODEM_MEM_BASE + _TGT_MODEM_MEM_SIZE)/*254*/

#if ((_TGT_SMD_MEM_BASE + _TGT_SMD_MEM_SIZE) != _TGT_AP_MEM_SIZE)
...
/* #define _TGT_AP_CAM_CSI_CHANNEL_SEL 1 */
