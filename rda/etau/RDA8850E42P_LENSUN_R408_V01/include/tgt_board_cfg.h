...
{                                                                       \
    ...
    .camCsiId           = HAL_CAM_CSI_1,                             \
    .cam1Used           = TRUE,                                        \
    .cam1RstActiveH     = FALSE,                                        \
    .cam1PdnActiveH     = TRUE,                                         \
    .cam1PdnRemap       = GPIO_NONE,                                    \
    .cam1RstRemap       = GPIO_NONE,                                    \
    .cam1CsiId          = HAL_CAM_CSI_2,                             \
    .camMode            = HAL_CAM_MODE_CSI,                        \
}
#endif
    ...
    {                                                                   \
        ...
        {                                                               \
            ...
            { /* PMD_POWER_LCD          : (main) LCD LDO enable */      \
                .ldo            = { .opal = PMD_LDO_LCD | PMD_LDO_BLLED},               \
                .polarity       = TRUE,                                 \
                .shared         = FALSE,                                \
                .powerOnState   = FALSE,                                \
            },                                                          \
        ...
        .vBuck1LowPower              = 6,                               \
        .vBuck3LowPower              = 13,                              \
        .vBuck4Usage                 = PMD_VBUCK4_USAGE_2P8V_ALWAYS_ON, \
        .vBuck4LowPower              = 13,                              \
        .vSim2Usage                  = PMD_VSIM2_USAGE_2P8V_ALWAYS_ON,             \
        .batteryGpadcChannel         = HAL_ANA_GPADC_CHAN_7,            \
        .batteryLevelChargeTermMV    = 4200,                            \
        .batteryLevelRechargeMV      = 4190,                            \
        .batteryLevelFullMV          = 4100,                            \
        .batteryChargeTimeout        = 4 HOURS,                         \
        .batteryOffsetHighActivityMV = 65,                              \
        .batteryOffsetPowerDownChargeMV = -50,                         \
        .powerOnVoltageMV            = 3400,                            \
        .powerDownVoltageMV          = 3400,                            \
        .batteryChargeCurrent        = PMD_CHARGER_1000MA,              \
        .batteryChargeCurrentOnUsb   = PMD_CHARGER_500MA,               \
        .batteryTsDetect             = FALSE,                           \
        .chargerGpadcChannel         = HAL_ANA_GPADC_CHAN_6,            \
        .chargerLevelUpperLimit      = 7000,                            \
        .chargerOffsetBackToNormal   = -200,                            \
        .temperatureGpadcChannel     = HAL_ANA_GPADC_CHAN_6,            \
        .temperatureUpperLimit       = 0,                               \
        .temperatureOffsetBackToNormal = 0,                             \
...
#define TGT_PMD_BATT_VOLTAGE_ARRAY                                    \
   {3400,3646,3736,3776,3801,3821,3835,3845,3853,3863,3875,3888,3902,3918,3940,3966,3990,4016,4044,4070,4100}
