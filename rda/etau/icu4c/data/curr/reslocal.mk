...
CURR_SYNTHETIC_ALIAS = in.txt in_ID.txt id_ID.txt zh_CN.txt zh_HK.txt\
zh_Hans_CN.txt zh_Hant_TW.txt zh_MO.txt zh_SG.txt zh_TW.txt en_NH.txt en_RH.txt
...
# END Android-add
CURR_SOURCE = en.txt en_AG.txt en_AU.txt\
 ...
 en_US.txt en_UG.txt en_VC.txt en_VU.txt en_WS.txt en_ZA.txt\
 en_ZM.txt en_ZW.txt\
 my.txt id.txt zh.txt\
