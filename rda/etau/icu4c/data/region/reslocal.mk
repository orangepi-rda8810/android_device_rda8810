...
REGION_SYNTHETIC_ALIAS = in.txt in_ID.txt id_ID.txt zh_CN.txt\
 zh_HK.txt zh_Hans_CN.txt zh_Hant_MO.txt zh_Hant_TW.txt zh_MO.txt\
 zh_SG.txt zh_TW.txt en_NH.txt en_RH.txt en_VU.txt en_ZW.txt
...
# Ordinary resources
REGION_SOURCE = en.txt en_GB.txt my.txt id.txt\
zh.txt zh_Hans.txt zh_Hans_HK.txt zh_Hans_MO.txt\
zh_Hans_SG.txt zh_Hant.txt zh_Hant_HK.txt 
