...
GENRB_SYNTHETIC_ALIAS = in.txt in_ID.txt zh_CN.txt zh_HK.txt zh_MO.txt zh_SG.txt\
 zh_TW.txt en_NH.txt en_RH.txt
...
# Ordinary resources
GENRB_SOURCE = en.txt en_150.txt en_AG.txt\
 ...
 my.txt my_MM.txt id.txt id_ID.txt\
 zh.txt zh_Hans.txt zh_Hans_CN.txt zh_Hans_HK.txt\
 zh_Hans_MO.txt zh_Hans_SG.txt zh_Hant.txt zh_Hant_HK.txt zh_Hant_MO.txt\
 zh_Hant_TW.txt ps.txt ps_AF.txt
