...
#define _TGT_AP_OS_MEM_SIZE		460
...
/*use hd(high density) version of v1 dirver*/
#define _TGT_AP_NAND_V1_HIGHDENSITY

/* because of spl code size limit, three type nand driver could only */
/* compile one of them.*/
#define _PARALLEL_NAND_USED_ 0
#define _SPI_NAND_USED_ 1
#define _EMMC_NAND_USED_ 2
#define _TGT_NAND_TYPE_ _PARALLEL_NAND_USED_
...
/*nand read delay, specillay for 16K nand*/
#define _TGT_AP_NAND_READDELAY 0x6
...
//LuoShuli 2015/01/12 for RC5011 gsensor MC3433
# define _DEF_I2C_ADDR_GSENSOR_MC3XXX   (0x4c)
...
# define _TGT_AP_VIBRATOR_TIME       (1000)
