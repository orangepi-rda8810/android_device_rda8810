...
/* DDR timing */
/*#include "ddr_timing/8811d_u08_16x2_290m_ddr2.h"*/
#include "ddr_timing/8811p_16x2_260m_ddr2.h"

/*
 * CLK settings
 */
#define _TGT_AP_CLK_CPU         (0x001F)
#define _TGT_AP_CLK_AXI         (0x001A)
//#define _TGT_AP_CLK_GCG         (0x001E)
#define _TGT_AP_CLK_GCG         (0x001D)	//LuoShuli 2014/10/21
