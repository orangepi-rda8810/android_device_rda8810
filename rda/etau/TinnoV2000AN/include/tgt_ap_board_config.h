...
#define _TGT_AP_OS_MEM_SIZE		230
...
/* _TGT_AP_CAM_CSI_AVDD  0:vcam=1.8v 1:vcam=2.8v*/
#define _TGT_AP_CAM_CSI_AVDD (0)

#define _TGT_AP_CAM0_LANE2_ENABLE	(0)
#define _TGT_AP_CAM1_LANE2_ENABLE	(0)

/* Enable ISP for RDA raw sensor */
#define _TGT_AP_CAM_ISP_ENABLE
/*
 * camera sensor flip & mirror setting:
 *   0: none, 1: mirror, 2: flip, 3: flip & mirror
 */
#define _TGT_AP_CAM_FLIP_MIRROR_ENABLE	(0x3)

/* External pwml to control lcd backlight defination */
//#define _TGT_AP_BL_EXT_PWM
//#define _TGT_AP_BL_EXT_GPIO_ENABLE     (1)
//#define _TGT_AP_GPIO_EXT_BL_ON         GPIO_A5
/* LED defination */
