...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .vBuck1LowPower              = 6,                               \
        .vBuck3LowPower              = 13,                              \
        .vBuck4Usage                 = PMD_VBUCK4_USAGE_NONE, \
        .vBuck4LowPower              = 13,                              \
        .vSim2Usage                  = PMD_VSIM2_USAGE_2P8V,             \
...
#define TGT_PMD_BATT_VOLTAGE_ARRAY                                    \
	{3400,3633,3673,3715,3740,3753,3769,3784,3792,3800,3813,3827,3846,3864,3893,3925,3956,3989,4023,4056,4100}
