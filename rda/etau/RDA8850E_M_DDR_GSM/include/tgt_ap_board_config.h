...
#define _TGT_MODEM_MEM_BASE	(_TGT_AP_GFX_MEM_BASE + _TGT_AP_GFX_MEM_SIZE) /*224*/
#define _TGT_AP_CAM_MEM_BASE	(_TGT_MODEM_MEM_BASE + _TGT_MODEM_MEM_SIZE) /*228*/
#define _TGT_AP_VPU_MEM_BASE	(_TGT_AP_CAM_MEM_BASE + _TGT_AP_CAM_MEM_SIZE) /*234*/
...
#define _TGT_AP_CAM0_CSI_CH_SEL	(1)
#define _TGT_AP_CAM1_CSI_CH_SEL	(0)
