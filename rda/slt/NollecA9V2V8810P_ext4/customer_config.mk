...
PRODUCT_COPY_FILES += \
    ...
    $(BOARDDIR)/$(TARGET_HARDWARE_CFG)/bootshutdownres/bootanimation2.zip:vendor/media/bootanimation2.zip \
    $(BOARDDIR)/$(TARGET_HARDWARE_CFG)/bootshutdownres/shutanimation.zip:vendor/media/shutanimation.zip \
    $(BOARDDIR)/$(TARGET_HARDWARE_CFG)/bootshutdownres/shutanimation2.zip:vendor/media/shutanimation2.zip
