...
#define _TGT_AP_GPIO_TOUCH_RESET        GPIO_B9
#define _TGT_AP_GPIO_TOUCH_IRQ          GPIO_B4

//#define _TGT_AP_GPIO_CAM_RESET
//#define _TGT_AP_GPIO_CAM_PWDN0
#define _TGT_AP_GPIO_CAM_PWDN1		GPIO_B24
#define _TGT_AP_GPIO_CAM_FLASH		GPO_1
...
#define _TGT_AP_GPIO_GSENSOR_WAKE       GPIO_B4
