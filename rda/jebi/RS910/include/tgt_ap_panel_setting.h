...
#define AUTO_DETECT_SUPPORTED_PANEL_LIST \
		ASPACE(HX8379C_CPT45_MIPI_PANEL_NAME)	\
		ASPACE(OTM8019A_CPT45_MIPI_PANEL_NAME)

/*For rda panel driver init*/
#define TGT_AP_PANEL_HX8379C_CPT45_MIPI 	1
#define	TGT_AP_PANEL_OTM8019A_CPT45_MIPI	1
