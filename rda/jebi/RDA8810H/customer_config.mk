...
#origin package placed in device/rda/common/preinstallapk
...
PRODUCT_COPY_FILES += \
    $(foreach apk,$(PrebuildExternal_PACKAGES),device/rda/common/preinstallapk/$(apk).apk:vendor/preinstall/$(apk).apk) \
    $(foreach apk,$(PrebuildInternal_PACKAGES),device/rda/common/preinstallapk/$(apk).apk:vendor/app/$(apk).apk) \
