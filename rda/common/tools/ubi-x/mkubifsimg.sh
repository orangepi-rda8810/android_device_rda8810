...
logical_block_bumber_of_this_partition=`expr $physical_block_number_of_this_partition - $bad_block_handle_reserved_blocks`
logical_block_bumber_of_this_partition=`expr $logical_block_bumber_of_this_partition  - $wl_reserved_blocks`
logical_block_bumber_of_this_partition=`expr $logical_block_bumber_of_this_partition  - $eba_reserved_blocks`
logical_block_bumber_of_this_partition=`expr $logical_block_bumber_of_this_partition  - $layout_volume_reserved_blocks`
logical_block_bumber_of_this_partition=`expr $logical_block_bumber_of_this_partition  - $max_tolerate_bad_block_number`
echo "LOGICAL BLOCK NUMBER OF PARTITION     --- ($logical_block_bumber_of_this_partition)"

# FILE SYSTEM VOLUEM SIZE = LOGICAL BLOCK NUMBER * LOGICAL ERASE BLOCK SIZE
fs_vol_size=`expr $logical_block_bumber_of_this_partition \* $logical_erase_block_size`
...
mkubifs \
	...
	-c $logical_block_bumber_of_this_partition \
	-r $input_dir \
	-o $ubifs_img_file \
	-x $compr_name \
	-F \
